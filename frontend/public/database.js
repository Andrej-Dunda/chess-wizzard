...
// db initialization
db.serialize(() => {
  db.run('CREATE TABLE IF NOT EXISTS tournaments (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, date TEXT, players_table_name TEXT, phase TEXT, round INTEGER)');
});
